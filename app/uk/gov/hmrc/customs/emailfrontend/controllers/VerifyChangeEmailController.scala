...
class VerifyChangeEmailController @Inject() (
            ...
            formData =>
              formData.isVerify match {
                ...
                case Some(false) =>
                  ...
                  save4LaterService
                    .saveEmail(request.user.internalId, EmailDetails(Some(email), emptyString, None))
                    .map { _ =>
                ...
                case Some(true) =>
                  ...
                  callEmailVerificationService(
                    ...
                    EmailDetails(Some(email), email, None),
                    request.user.eori
                  )
