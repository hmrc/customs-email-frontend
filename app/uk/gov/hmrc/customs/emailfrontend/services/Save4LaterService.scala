...
class Save4LaterService @Inject() (save4LaterConnector: Save4LaterConnector) extends Logging {
  ...
  def saveEmail(internalId: InternalId, emailDetails: EmailDetails)(implicit
    hc: HeaderCarrier
  ...
  def saveJourneyType(internalId: InternalId, isVerify: JourneyType)(implicit
    hc: HeaderCarrier
  ): Future[Either[HttpErrorResponse, Unit]] = {
  ...
  def saveReferrer(internalId: InternalId, referrerName: ReferrerName)(implicit
    hc: HeaderCarrier
  ): Future[Either[HttpErrorResponse, Unit]] = {
  ...
  def fetchReferrer(internalId: InternalId)(implicit hc: HeaderCarrier): Future[Option[ReferrerName]] = {
...
object Save4LaterService extends Logging {
  ...
  implicit class EmailCacheServiceHelper(save4LaterService: Save4LaterService) {
    ...
    def routeBasedOnAmendment(
      internalId: InternalId
    )(redirectBasedOnEmailStatus: EmailDetails => Future[Result], noEmail: Future[Result])(implicit
      hc: HeaderCarrier,
