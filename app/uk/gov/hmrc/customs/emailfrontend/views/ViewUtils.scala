...
object ViewUtils {
  ...
  def title(form: Form[_], titleStr: String, titleMessageArgs: Seq[String] = Seq())(implicit
    messages: Messages
  ): String =
  ...
  def errorPrefix(form: Form[_], prefixString: String = "site.errorPrefix")(implicit messages: Messages): String =
